    ...
    Column() {
        Box() {
            TextField(modifier = Modifier
                .fillMaxWidth()
                .padding(start = 8.dp, top = 8.dp, end = 8.dp), value = searchState.searchWord,
                trailingIcon = {
                    Icon(imageVector = if (searchState.isHintVisible) Icons.Outlined.Search else Icons.Outlined.Clear,
